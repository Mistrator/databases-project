...
Tämän jälkeen \verb|kayttotapaukset.sql|-tiedoston käskyjä voidaan ajaa. Käyttötapaukset kannattaa käydä läpi järjestyksessä. Kaikkien käskyjen pitäisi onnistua.
